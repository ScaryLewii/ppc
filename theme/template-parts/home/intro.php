...
<div class="bg-fixed bg-cover bg-center bg-no-repeat"
	...
	<div class="bg-blue text-white p-20 min-h-[100vh] flex items-center">
		<div>
			<span class="text-[16px] tracking-[1.6px] font-semibold">GIỚI THIỆU</span>
			<h3 class="text-[36px] font-semibold leading-[47px] mt-[10px]">Hợp tác Công - Tư (PPC) thúc đẩy xây dựng nền kinh tế tuần hoàn để xử lý vấn đề rác thải nhựa tại Việt Nam</h3>
