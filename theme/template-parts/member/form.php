	...
	<div class=" max-w-[960px] mx-auto">
		<div class="bg-blue rounded-2xl overflow-hidden">
			...
			<div class="p-16 pt-8 flex flex-col gap-10">
				...
				Tổ công tác hoan nghênh kết nạp các thành viên mới từ khu vực tư nhân,
				có cam kết phát triển bền vững mạnh mẽ và có thể cống hiến thúc đẩy triển khai các dự án kinh tế tuần hoàn tại Việt Nam.
				</div>
					...
					<form class="w-full flex flex-col gap-[30px] p-10 bg-light rounded-b-2xl">
						<label class="flex flex-col gap-2">
							...
							<div class="flex justify-end">
								<button type="submit" class="font-semibold text-[24px] bg-sea hover:bg-orange rounded text-white
